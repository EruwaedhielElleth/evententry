...
def build_embed():
    ...
    embed = discord.Embed(
        ...
        description="Click buttons to lock or unlock difficulties.",
    ...
    embed.set_footer(text="Only the locker can unlock. Anyone may force unlock.")
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if not info["locked"]:
            ...
            await interaction.response.send_message(
                f"{switch_name} is already unlocked.",
                ephemeral=True
            )
...
class DifficultyView(discord.ui.View):
    ...
    async def handle_toggle(self, interaction, switch_name):
        ...
        # DENY
        await interaction.response.send_message(
            f"Only {info['username']} can unlock {switch_name}.",
            ephemeral=True
        )
