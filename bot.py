...
class ForceUnlock(discord.ui.Button):
    def __init__(self):
        super().__init__(label="Force Unlock", style=discord.ButtonStyle.grey)
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await log(gid, f"{interaction.user.display_name} FORCE UNLOCKED ALL BUTTONS")
        await update_panel(interaction.guild)
